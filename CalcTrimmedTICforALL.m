...
for i=1:13
    ...
    [DataSetBase{i}.Trim.t,DataSetBase{i}.Trim.ic] = RemoveHAneurons(t,ic,[DataSetBase{i}.Trim.bs,DataSetBase{i}.sbs],[DataSetBase{i}.Trim.be,DataSetBase{i}.sbe]);
    ...
    [DataSetStims{i}.Trim.t,DataSetStims{i}.Trim.ic] = RemoveHAneurons(t,ic,[DataSetStims{i}.Trim.bs,DataSetStims{i}.sbs],[DataSetStims{i}.Trim.be,DataSetStims{i}.sbe]);
