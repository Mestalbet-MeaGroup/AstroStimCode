...
mBase = PlotBurstPropogation(DataSetBase{j}.Trim.t,DataSetBase{j}.Trim.ic,sort([DataSetBase{j}.Trim.bs,DataSetBase{j}.sbs]),sort([DataSetBase{j}.Trim.be,DataSetBase{j}.sbe]));
figure;
mStim = PlotBurstPropogation(DataSetStims{j}.Trim.t,DataSetStims{j}.Trim.ic,sort([DataSetStims{j}.Trim.bs,DataSetStims{j}.sbs]),sort([DataSetStims{j}.Trim.be,DataSetStims{j}.sbe]));
